...
def update_output_container(selected_year, selected_statistic):
    ...
    #TASK 2.5: Create and display graphs for Recession Report Statistics
        ...
        unemp_sales = data.groupby(by=['unemployment_rate', 'Vehicle_Type'])['Automobile_Sales'].sum().reset_index()
        # Create a bar chart
        R_chart4 = dcc.Graph(
            figure=px.bar(
                unemp_sales,
                ...
                labels={'Automobile_Sales': 'Number of Vehicles Sold', 'Unemployment_Rate': 'Unemployment Rate (%)'}
            ))
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots                             
        ...
        Y_chart2 = dcc.Graph(
            figure=px.line(
                monthly_sales, x='Month', y='Automobile_Sales', title='Total Monthly Automobile Sales'
            )
        )
